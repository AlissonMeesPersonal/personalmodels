...
export async function POST(request:Request){
 ...
 const {error}=await db.from('personal_cref_reviews').upsert({user_id:user.id,cref:profile.cref,cref_state:profile.cref_state,status:'pending',reviewed_at:null},{onConflict:'user_id'});
